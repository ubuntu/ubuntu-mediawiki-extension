...
The most straightforward way to report a security vulnerability is via [GitHub](https://github.com/ubuntu/ubuntu-mediawiki-extension/security/advisories/new).
...
1. Go to the [Security Advisories Page](https://github.com/Ubuntu/ubuntu-mediawiki-extension/security/advisories) of the repository.
