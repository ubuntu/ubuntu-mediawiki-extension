...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `ext.ubuntu.styles`         | Common layer applied to every skin: Vanilla palette tokens (CSS custom properties), Ubuntu Sans webfonts, variables/mixins, and skin-agnostic component styles (footer, site notice, code blocks). The ubuntu skin fork depends on these tokens and fonts directly. | Every page view (added in `Hooks::onBeforePageDisplay`); minerva additionally gets it via `ResourceModuleSkinStyles` |
